const Footer = () => {
  return (
    <footer className="bg-footer w-full pb-1">
      <div className="px-2 lg:px-28 md:px-10 pt-4 lg:pt-10 md:pt-6 divide-y divide-gray-700">
        <div className="md:flex md:justify-evenly mb-10 lg:gap-10 md:gap-5">
          <div className="md:flex-grow md:w-1/3 mb-4 md:mb-0">
            ...
            <p className="opacity-50 mt-4 lg:text-base text-sm">
              A non profit crowdfunding platform to allow financially challenged
              people to campaign for donations for medical needs.
            </p>
          </div>

          <div className="flex justify-evenly mb-10 gap-3 lg:gap-10 md:gap-5">
            <div className="md:flex-grow md:w-1/3 mb-4 md:mb-0">
              <h1 className="text-lg lg:text-2xl md:text-xl font-semibold lg:mb-4 md:mb-3 mb-1">
                Developer Contact
              </h1>
              <div className="flex flex-grow w-full gap-2 opacity-50 lg:mb-4 mb-2 lg:text-base text-sm">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 39 44"
              ...
              <div className="flex gap-2 opacity-50 lg:mb-4 mb-2 lg:text-base text-sm">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 52 54"
            ...
            <div className="md:flex-grow md:w-1/3">
              <h1 className="lg:text-2xl md:text-xl text-lg font-semibold lg:mb-4 md:mb-3 mb-1">
                Credits
              </h1>
              <ul className="list-disc opacity-50 ml-4 lg:text-base text-sm">
                <li>
